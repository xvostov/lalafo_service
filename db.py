...
class DataBaseHandler:
    def __init__(self):
        ...
        logger.debug('Checking the om "viewed_links_lalafo" table')
        self.mysql_cursor.execute("""
        CREATE TABLE IF NOT EXISTS viewed_links_lalafo (
        ...
        # logger.debug('Checking the om "blacklist_lalafo" table')
        # self.mysql_cursor.execute("""
        # CREATE TABLE IF NOT EXISTS blacklist_lalafo (
    ...
    def add_to_viewed_links(self, url: str):
        ...
        while True:
            try:
                self.mysql_cursor.execute("INSERT INTO viewed_links_lalafo VALUES(%s)", (url,))
    ...
    #     self.mysql_cursor.execute("SELECT seller_id FROM blacklist_lalafo")
    #     resp = self.mysql_cursor.fetchall()
    #
    #     return [d[0] for d in resp]
